...
if ( isset( $autogen ) && $autogen === true ): ?>
	<!-- This static cheatsheet was AUTOGENERATED with PHP <?php print PHP_VERSION; ?>-->
<?php
endif; ?>

	<title><?php print htmlspecialchars( $page_title, ENT_QUOTES, 'UTF-8' ) . ( isset( $tab ) ? ' :: ' . $tab : '' ) . ( isset( $type ) ? ' Cheatsheet for PHP ' . htmlspecialchars( PHP_VERSION, ENT_QUOTES, 'UTF-8' ) : '' ); ?></title>
...
<?php
	...
	<div id="main-menu">
		<ul>
			<li><a href="./<?php echo $dir; ?>index.php?page=compare" class="top-link<?php if ( isset( $type ) && $type === 'compare' ) print ' top-active'; ?>">Variable Comparisons</a></li>
			<li><a href="./<?php echo $dir; ?>index.php?page=arithmetic" class="top-link<?php if ( isset( $type ) && $type === 'arithmetic' ) print ' top-active'; ?>">Variable Arithmetics</a></li>
			<li><a href="./<?php echo $dir; ?>index.php?page=test" class="top-link<?php if ( isset( $type ) && $type === 'test' ) print ' top-active'; ?>">Variable Testing</a></li>
			<li><a href="./<?php echo $dir; ?>index.php?page=other-cheat-sheets" class="top-link<?php if ( isset( $page ) && $page === 'other-cheat-sheets' ) print ' top-active'; ?>">More cheatsheets</a></li>
			<li class="top-link-small"><a href="./<?php echo $dir; ?>index.php?page=about" class="top-link<?php if ( isset( $page ) && $page === 'about' ) print ' top-active'; ?>">About</a></li>
		</ul>
	</div>
<?php
	endif;
