		...
		<div id="main-menu">
			<p>
				<a href="index.php?page=compare" class="top-link<?php if ( $type === 'compare' ) { echo ' top-active'; } ?>">
					...
					<img src="./page/images/screenshot-var-compare.png" width="220" height="220" alt="Variable Comparison Cheatsheet Screenshot" />
				</a>
				<a href="index.php?page=arithmetic" class="top-link<?php if ( $type === 'arithmetic' ) { echo ' top-active'; } ?>">
					Variable&nbsp;Arithmetic<br />Cheat&nbsp;sheet
					<img src="./page/images/screenshot-var-arithm.png" width="220" height="220" alt="Variable Arithmetic Cheatsheet Screenshot" />
				</a>
				<a href="index.php?page=test" class="top-link<?php if ( $type === 'test' ) { echo ' top-active'; } ?>">
					Variable&nbsp;Testing<br />Cheat&nbsp;sheet
					<img src="./page/images/screenshot-var-tests.png" width="220" height="220" alt="Variable Testing Cheatsheet Screenshot" />
				</a>
			</p>
		</div>
