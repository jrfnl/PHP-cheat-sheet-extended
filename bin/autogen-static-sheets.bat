...
:: 5.0        5.0.5     5.0.4
:: 5.1        5.1.6     5.1.6
:: 5.2        5.2.17    5.2.17, 5.2.6, 5.2.14
:: 5.3        5.3.29    5.3.29, 5.3.3, 5.3.28, 5.3.10, 5.3.27 (v28 not included in run as 27 + 29 are)
:: 5.4        5.4.45    5.4.45, 5.4.16, 5.4.41, 5.4.4
:: 5.5        5.5.38    5.5.38, 5.5.9, 5.5.30, 5.5.22, 5.5.35
:: 5.6        5.6.32    5.6.31, 5.6.30, 5.6.32, 5.6.29, 5.6.21, 5.6.25 (v30, v29, v27 not included in run as 28 + 30 are)
:: 7.0        7.0.26    7.0.25, 7.0.24, 7.0.23, 7.0.21, 7.0.22, 7.0.20, 7.0.19 ... 7.0.15, ... 7.0.6
:: 7.1        7.1.12    7.1.11, 7.1.10, 7.1.9, 7.1.7, 7.1.5, 7.1.8
:: 7.2        7.2.0
::
...
:RUN_AUTOGEN
FOR %%G IN (7.2.0) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (7.1.12 7.1.7 7.1.0) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (7.0.26 7.0.21 7.0.19 7.0.14 7.0.4) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (5.6.32 5.6.29 5.6.25 5.6.21 5.6.16 5.6.7) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (5.5.38 5.5.30 5.5.22 5.5.16 5.5.9) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (5.4.45 5.4.41 5.4.27 5.4.16 5.4.4) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (5.3.29 5.3.27 5.3.10 5.3.3) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (5.2.17 5.2.6) DO CALL :RUN_AUTOGEN_PHP5 %%G
...
:: Regen sitemap files
:SITEMAPS
SET "_CURRENT_PHP_CLI=%_LOCAL_PHP_BIN_DIR%\php5.6.32\php.exe"
SET "_CURRENT_PHP_INI=%_LOCAL_PHP_BIN_DIR%\php5.6.32\php.ini"
