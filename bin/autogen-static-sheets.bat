...
:: 5.4        5.4.45    5.4.45, 5.4.43, 5.4.16, 5.4.41, 5.4.44, 5.4.36, 5.4.39, 5.4.4 (v44, v43, v39 not included in run as 41 and 36 are)
:: 5.5        5.5.37    5.5.9, 5.5.36, 5.5.35, 5.5.30, 5.5.34, 5.5.33, 5.5.32, 5.5.31, 5.5.22 (v31, v32, v29 and v21 not included in run as 22, 28, 30 and 33 are)
:: 5.6        5.6.23    5.6.22, 5.6.21, 5.6.20, 5.6.16, 5.6.18, 5.6.19, 5.6.17, 5.6.23, 5.6.14 (v22, v21, v19, v18, v17, v14 not included as 23, 20, 16, and 13 are)
:: 7.0        7.0.8     7.0.7, 7.0.6, 7.0.5, 7.0.8, 7.04, 7.0.0
:: 7.1        7.1.0-alpha3
::
...
:RUN_AUTOGEN
FOR %%G IN (7.1.0alpha3) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (7.0.8 7.0.6 7.0.4 7.0.0) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (5.6.23 5.6.20 5.6.16 5.6.13 5.6.7 5.6.0) DO CALL :RUN_AUTOGEN_PHP5 %%G
FOR %%G IN (5.5.37 5.5.33 5.5.30 5.5.22 5.5.16 5.5.9 5.5.3) DO CALL :RUN_AUTOGEN_PHP5 %%G
